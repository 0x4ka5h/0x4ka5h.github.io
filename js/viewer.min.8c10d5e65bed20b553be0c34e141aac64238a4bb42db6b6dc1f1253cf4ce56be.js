window.viewerOptions={};/*! For license information please see viewer.js.LICENSE.txt */(()=>{var n={1540:(e,t,n)=>{"use strict";n.d(t,{Z:()=>r});var o=n(3645),i=n.n(o),a=n(6127),s=i()(function(e){return e[1]});s.i(a.Z),s.push([e.id,".viewer-toolbar ul li{margin-right:.25rem}.viewer-backdrop{background-color:rgba(0,0,0,.85)}",""]);const r=s},6127:(e,t,n)=>{"use strict";n.d(t,{Z:()=>i});var o=n(3645),s=n.n(o)()(function(e){return e[1]});s.push([e.id,`/*!
 * Viewer.js v1.10.2
